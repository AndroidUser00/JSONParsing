...
JSONObject properties = currentEarthquake.getJSONObject("properties");
             ...
             double magi = properties.getDouble("mag");
                String location = properties.getString("place");
                String time  = properties.getString("time");
                long t = properties.getLong("time");
                Date millisecond = new Date(t);
                SimpleDateFormat sdf = new SimpleDateFormat("MMM DD, yyyy");
                String date = sdf.format(millisecond);
String webUri = properties.getString("url");
                Data datat = new Data(magi,location,t,webUri);
                earthquakes.add(datat);
            }
